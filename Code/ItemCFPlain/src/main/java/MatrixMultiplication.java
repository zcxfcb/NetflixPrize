...
public class MatrixMultiplication {
	public static class CooccurrenceMapper extends Mapper<LongWritable, Text, Text, Text> {
		...
		public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
			//parse input data, which is in the form of "movieB \t movieA=relation"
	...
	public static class MultiplicationReducer extends Reducer<Text, Text, Text, DoubleWritable> {
		...
		public void reduce(Text key, Iterable<Text> values, Context context)
			...
			fillMaps(values, relationMap, ratingMap);
		...
		private void fillMaps(Iterable<Text> values, Map<String, Double>relationMap, Map<String, Double> ratingMap) {
