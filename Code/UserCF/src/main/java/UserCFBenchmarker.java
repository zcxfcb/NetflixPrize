 ...
 */
public class UserCFBenchmarker {
  ...
  public static class PredictionMapper extends Mapper<LongWritable, Text, Text, Text> {
    ...
    public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
      String[] line = value.toString().split("\t");
      String[] movieUser = line[0].split(":");
      context.write(new Text(movieUser[1] + ":" + movieUser[0]), new Text("predicted:" + line[1]));
    }
  }
  ...
  public static class BenchmarkingReducer extends Reducer<Text, Text, Text, Text> {
    ...
    protected void cleanup(Context context) throws IOException, InterruptedException {
      System.out.println("variance for User_CF:" + squareSum/count);
  ...
  public static void main (String[] args) throws Exception {
    ...
    job.setJarByClass(UserCFBenchmarker.class);
